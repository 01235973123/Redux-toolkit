...
export const todoStatusSelector = (state) => state.filters?.status;

export const todosRemainingSelector = createSelector(todoListSelector, todoStatusSelector,
  searchTextSelector, filterPrioritiesSelector, (todoList, status, searchText, priorities) => {
